      ...
      <main className="flex overflow-hidden flex-1">
        <div className="flex-1 p-4">
          ...
          <div className="flex items-center mb-4 space-x-2">
            <input
              type="text"
              className="flex-grow px-3 py-2 rounded-md border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-300 placeholder-gray-500 dark:placeholder-gray-400"
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                ...
                {cues.map((cue, index) => (
                  <React.Fragment key={cue.id}>
                    <tr className="group hover:bg-gray-50 dark:hover:bg-gray-800">
                      <td className="p-2">
                        <DropdownMenu.Root>
                          ...
                          <DropdownMenu.Portal>
                            <DropdownMenu.Content
                              className="min-w-[160px] bg-white dark:bg-gray-800 rounded-md shadow-lg p-1 z-50 border border-gray-200 dark:border-gray-700"
                              sideOffset={5}
                            >
                              <DropdownMenu.Item
                                className="text-sm px-2 py-1.5 outline-none cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 rounded text-gray-700 dark:text-gray-300"
                      ...
                      <td className="p-2">
                        <div className="flex gap-1">
                          ...
                          <button
                            ...
                            className="p-1 rounded opacity-0 transition-opacity group-hover:opacity-100 hover:bg-gray-100 dark:hover:bg-gray-700 text-red-500 dark:text-red-400"
                          >
